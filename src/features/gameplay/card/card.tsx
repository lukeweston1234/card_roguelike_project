      ...
      >
        ...
        <div className="[via-transparent] to-[rgba(9, 17, 34, 0)] absolute left-0 top-0 flex h-[140px] w-full flex-col items-center rounded-t-[22px] bg-gradient-to-b from-[#091122]">
          ...
          <div className="flex flex-row">
            ...
            <h6 className="neon-text">{cardProps.cardStats.damage}</h6>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
            ...
            <h6 className="neon-text">{cardProps.cardStats.energy}</h6>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
            ...
            <h6 className="neon-text">{cardProps.cardStats.cost}</h6>
          </div>
        </div>
